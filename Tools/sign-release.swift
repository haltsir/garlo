// Signs a release zip with the ed25519 key in ~/.config/garlo/release-key
...
//
//   swift Tools/sign-release.swift Garlo-X.Y.Z.zip
...
let keyPath = ("~/.config/garlo/release-key" as NSString).expandingTildeInPath
